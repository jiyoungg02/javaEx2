...
public class Ex05 {
	public static void main(String[] args) {
		...
		boolean b = s1.contains("ko"); //대소문자구분
		System.out.println("포함여부 : " + b); //true
		...
		System.out.println("영문자제거: " + s2); // 우리 123 나라  대한민국
		
		s1 = "우리 123 나라 axb 대한AA민국";
		s2 = s1.replaceAll("[a-zA-z0-9]", ""); // 영숫자 제거
		System.out.println("영숫자제거: " +s2); // 우리  나라  대한민국
		...
		System.out.println("영숫자와 대한 제거: " +s2); // 우리  나라  민국
