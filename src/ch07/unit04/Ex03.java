...
public class Ex03 {
	public static void main(String[] args) {
		...
		// substring(s, e) : s인덱스에서 e-1인덱스까지 문자열 추출(e-s개)
		// 인덱스 0부터 시작
		s2 = s1.substring(6, 9); //6인덱스에서 (9-6)인 3개 추출
		System.out.println(s2); // kor
		
		//6인덱스에서 마지막 문자열까지 추출
		s2 = s1.substring(6);
		System.out.println("특정 인덱스에서 마지막 까지 : "+s2); //korea
		
		s2 = s1.toUpperCase();
		System.out.println("모두 대문자로 : " + s2);
		...
		System.out.println("ascii 코드 차이 : " + n);
