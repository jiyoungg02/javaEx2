...
public class Ex01_Interface {
	public static void main(String[] args) {
		// Demo1 obj = new Demo1(); // 컴오류 인터페이스는 객체 생성 불가
		...
		// obj.sub(); // 컴오류. 인터페이스에 sub() 메소드가 없음
		((DemoImpl1)obj).sub(); // down-casting
	
		// 필드는 인터페이스 명으로 접근
		System.out.println(Demo1.A);
		// Demo1.B = 100; // 컴오류. final 변수는 변경불가
	}
}
...
interface Demo1{
	...
	int B = 20; // public static final를 붙이지 않아도 public static final
	...
	// public void write() {}; // 메소드를 정의하면 컴오류
