...
public class Ex05_instanceof {
	public static void main(String[] args) {
		...
		System.out.println(t2.b); // 20 필드는 무조건 자기것
		// System.out.println(t3.c); // 컴파일오류. Test5에 c 필드가 없음
		System.out.println(((Demo5)t3).c); // 다운캐스팅
		
		t2.print(); // 메소드가 하위에서 재정의 되어 있으면 하위 메소드 호출(상위 메소드는 숨는다.)
		// t2.write(); // 컴오류. Test5에 메소드가 없음
		((Demo5)t2).write();
		
		// down casting
		// Demo5 d2 = (Demo5)t; // 런타임오류.
			// 업한것만 다운 가능
		...
		// 다운캐스팅 : 반드시 강제 캐스팅 필요. 업한것만 다운 가능
		Demo5 d3 = (Demo5)t2;
		Demo5 d4 = (Demo5)t3;
		Test5 t4 = (Test5)o;
